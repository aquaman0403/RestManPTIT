...
<main class="container">
    <div class="welcome-message">
        Xin chào <%= staff.getName().getLastName() + " " + staff.getName().getMiddleName() + " " + staff.getName().getFirstName()%>
    </div>
    <a href="${pageContext.request.contextPath}/view/staff/gdQLTTMonAn255.jsp" class="menu-button">Quản Lý Thông Tin Món Ăn</a>
